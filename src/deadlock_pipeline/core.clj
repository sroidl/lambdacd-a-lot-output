(ns deadlock-pipeline.core
  (:require
      [deadlock-pipeline.pipeline :as pipeline]
...
(defn copy-resource-to-home-dir [home-dir]
...
(defn -main [& args]
      (let [;; the home dir is where LambdaCD saves all data.
           ...
           (copy-resource-to-home-dir home-dir)
